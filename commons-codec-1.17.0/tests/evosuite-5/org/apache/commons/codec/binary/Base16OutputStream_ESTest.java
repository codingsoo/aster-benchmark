...
public class Base16OutputStream_ESTest extends Base16OutputStream_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "Parameter supplied to Base-N encode is not a byte[]");
      MockPrintStream mockPrintStream0 = new MockPrintStream(mockFile0);
      CodecPolicy codecPolicy0 = CodecPolicy.LENIENT;
      Base16OutputStream base16OutputStream0 = new Base16OutputStream(mockPrintStream0, true, false, codecPolicy0);
  ...
  public void test2()  throws Throwable  {
      ...
      Base16OutputStream base16OutputStream0 = new Base16OutputStream(byteArrayOutputStream0, true);
      assertFalse(base16OutputStream0.isStrictDecoding());
  }
}
