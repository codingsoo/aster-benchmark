...
public class BaseNCodec_ESTest extends BaseNCodec_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      Base32 base32_0 = new Base32((-59), byteArray0, false, (byte) (-1), codecPolicy0);
  ...
  public void test03()  throws Throwable  {
      ...
      baseNCodec_Context0.readPos = (-184);
      // Undeclared exception!
      try { 
        base16_0.readResults((byte[]) null, 13, 2251, baseNCodec_Context0);
  ...
  public void test04()  throws Throwable  {
      Base64 base64_0 = new Base64((-2958), (byte[]) null, false);
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      ...
      // Undeclared exception!
      try { 
        base64_0.encode((byte[]) null, (-2958), 3, baseNCodec_Context0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.readPos = (-1336);
      String string0 = baseNCodec_Context0.toString();
      assertEquals("Context[buffer=null, currentLinePos=0, eof=false, ibitWorkArea=0, lbitWorkArea=0, modulus=0, pos=0, readPos=-1336]", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.currentLinePos = 1030;
      String string0 = baseNCodec_Context0.toString();
      assertEquals("Context[buffer=null, currentLinePos=1030, eof=false, ibitWorkArea=0, lbitWorkArea=0, modulus=0, pos=0, readPos=0]", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      int int0 = base16_0.readResults(byteArray0, (byte)0, 76, baseNCodec_Context0);
  ...
  public void test11()  throws Throwable  {
      boolean boolean0 = BaseNCodec.isWhiteSpace((byte)31);
      assertTrue(boolean0);
  }
  ...
  public void test12()  throws Throwable  {
      byte[] byteArray0 = new byte[2];
      CodecPolicy codecPolicy0 = CodecPolicy.STRICT;
      Base64 base64_0 = new Base64(2440, byteArray0, false, codecPolicy0);
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.pos = 1387;
  ...
  public void test14()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      Base32 base32_0 = new Base32(1251, byteArray0, false);
      long long0 = base32_0.getEncodedLength(byteArray0);
  ...
  public void test17()  throws Throwable  {
      Base32 base32_0 = new Base32((-54), (byte[]) null);
  ...
  public void test21()  throws Throwable  {
      CodecPolicy codecPolicy0 = CodecPolicy.STRICT;
      Base16 base16_0 = new Base16(true, codecPolicy0);
      byte[] byteArray0 = base16_0.encode((byte[]) null, 0, 0);
  ...
  public void test24()  throws Throwable  {
      Base64 base64_0 = new Base64((-1721));
  ...
  public void test30()  throws Throwable  {
      ...
      byte[] byteArray0 = base32_0.decode("v");
      // Undeclared exception!
      try { 
        base32_0.readResults(byteArray0, 0, 200, (BaseNCodec.Context) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      baseNCodec_Context0.pos = 2921;
      baseNCodec_Context0.buffer = byteArray0;
      // Undeclared exception!
      try { 
        base32_0.readResults(byteArray0, (byte) (-105), 111, baseNCodec_Context0);
  ...
  public void test32()  throws Throwable  {
      ...
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      byte[] byteArray0 = base64_0.ensureBufferSize(236, baseNCodec_Context0);
  ...
  public void test36()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base16_0.ensureBufferSize(13, (BaseNCodec.Context) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 0, (int) (byte)27);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base16_0.decode("Strict decoding: Last encoded character (before the paddings if any) is a valid base 32 alphabet but not a possible encoding. Expected the discarded bits from the character to be zero.");
  ...
  public void test40()  throws Throwable  {
      Base32 base32_0 = new Base32((-801));
      byte[] byteArray0 = new byte[6];
  ...
  public void test41()  throws Throwable  {
      ...
      byte[] byteArray1 = base16_0.encode(byteArray0, 0, (int) (byte) (-55));
  ...
  public void test42()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[2];
      BaseNCodec.Context baseNCodec_Context0 = new BaseNCodec.Context();
      int int0 = base64_0.readResults(byteArray0, 0, (byte) (-128), baseNCodec_Context0);
      assertEquals(0, int0);
  }
  ...
  public void test43()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      CodecPolicy codecPolicy0 = CodecPolicy.STRICT;
      Base64 base64_0 = new Base64((-270), byteArray0, false, codecPolicy0);
  ...
  public void test46()  throws Throwable  {
      ...
      boolean boolean0 = base32_0.isInAlphabet("u1QA");
      assertFalse(boolean0);
  }
  ...
  public void test50()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base16_0.decode((Object) "codecPolicy");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid octet in encoded value: 99
         //
         verifyException("org.apache.commons.codec.binary.Base16", e);
      }
  }
  ...
  public void test56()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        base32_0.encode(byteArray0, 792, 107, baseNCodec_Context0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test59()  throws Throwable  {
      boolean boolean0 = BaseNCodec.isWhiteSpace((byte) (-76));
      assertFalse(boolean0);
  }
  ...
  public void test60()  throws Throwable  {
      Base32 base32_0 = new Base32(false);
      boolean boolean0 = base32_0.isInAlphabet("v");
      assertTrue(boolean0);
  }
