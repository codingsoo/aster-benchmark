...
public class BeiderMorseEncoder_ESTest extends BeiderMorseEncoder_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      BeiderMorseEncoder beiderMorseEncoder0 = new BeiderMorseEncoder();
      String string0 = beiderMorseEncoder0.encode("g#-^>>9J{dM");
      assertEquals("gidm|gzdm", string0);
  }
  ...
  public void test05()  throws Throwable  {
      BeiderMorseEncoder beiderMorseEncoder0 = new BeiderMorseEncoder();
      beiderMorseEncoder0.setMaxPhonemes((-1044));
      // Undeclared exception!
      try { 
        beiderMorseEncoder0.encode("?[&u5r+h_p3l");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal initial capacity: -1044
         //
  ...
  public void test11()  throws Throwable  {
      BeiderMorseEncoder beiderMorseEncoder0 = new BeiderMorseEncoder();
      Object object0 = beiderMorseEncoder0.encode((Object) " Os^y3'v;1>3Z$8");
      assertEquals("osif|osifS|osifs|osifts|osipS|osips|osivdS|osivds", object0);
  }
  ...
  public void test16()  throws Throwable  {
      BeiderMorseEncoder beiderMorseEncoder0 = new BeiderMorseEncoder();
      beiderMorseEncoder0.setMaxPhonemes((-1737));
      // Undeclared exception!
      try { 
        beiderMorseEncoder0.encode((Object) "du");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal initial capacity: -1737
         //
         verifyException("java.util.HashMap", e);
      }
  }
