...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      String string0 = OptionValidator.validate("ZA3e");
      assertEquals("ZA3e", string0);
  }
  ...
  public void test4()  throws Throwable  {
      try { 
        OptionValidator.validate(")3vM4~V");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test6()  throws Throwable  {
      try { 
        OptionValidator.validate("9-X3g,.qk7(M >C");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '9-X3g,.qk7(M >C' contains an illegal character : ','.
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
