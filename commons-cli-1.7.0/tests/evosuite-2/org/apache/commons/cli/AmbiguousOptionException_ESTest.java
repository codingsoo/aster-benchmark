...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        ambiguousOptionException0 = new AmbiguousOptionException("Ambiguous option: '", (Collection<String>) null);
  ...
  public void test1()  throws Throwable  {
      ...
      linkedList0.add(":O~xW+N{~D[~");
      linkedList0.addLast(":O~xW+N{~D[~");
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException(":O~xW+N{~D[~", linkedList0);
  }
  ...
  public void test2()  throws Throwable  {
      ...
      assertFalse(collection0.contains(":O~xW+N{~D[~"));
  }
}
