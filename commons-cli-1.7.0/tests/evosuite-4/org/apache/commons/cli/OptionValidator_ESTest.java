...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = OptionValidator.validate("Z");
  ...
  public void test4()  throws Throwable  {
      String string0 = OptionValidator.validate("@bB");
  ...
  public void test5()  throws Throwable  {
      try { 
        OptionValidator.validate("j47-^:Y?-");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'j47-^:Y?-' contains an illegal character : '^'.
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
