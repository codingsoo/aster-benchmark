...
public class XMLDocumentContainer_ESTest extends XMLDocumentContainer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      StreamSource streamSource0 = new StreamSource("Cannot read XML from: ");
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Cannot read XML from: Cannot read XML from: ; java.net.MalformedURLException: no protocol: Cannot read XML from: 
         //
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        xMLDocumentContainer0.setValue(object0);
