...
public class DynamicAttributeIterator_ESTest extends DynamicAttributeIterator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      NullPointer nullPointer0 = new NullPointer(locale0, "T-RR[i~F");
      QName qName0 = new QName((String) null, "T-RR[i~F");
      DynamicAttributeIterator dynamicAttributeIterator0 = new DynamicAttributeIterator(nullPointer0, qName0);
      // Undeclared exception!
      try { 
        dynamicAttributeIterator0.prepareForIndividualProperty("T-RR[i~F");
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        dynamicAttributeIterator0 = new DynamicAttributeIterator((PropertyOwnerPointer) null, (QName) null);
