...
public class DeflateParameters_ESTest extends DeflateParameters_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        deflateParameters0.setCompressionLevel(3415);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: 3415
         //
  ...
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        deflateParameters0.setCompressionLevel((-2591));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: -2591
         //
         verifyException("org.apache.commons.compress.compressors.deflate.DeflateParameters", e);
      }
  }
