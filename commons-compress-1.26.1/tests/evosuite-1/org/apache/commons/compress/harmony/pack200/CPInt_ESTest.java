...
public class CPInt_ESTest extends CPInt_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      CPInt cPInt0 = new CPInt(0);
      CPInt cPInt1 = new CPInt((-109));
      int int0 = cPInt0.compareTo(cPInt1);
      assertEquals((-109), cPInt1.getInt());
      assertEquals(1, int0);
  }
  ...
  public void test3()  throws Throwable  {
      ...
      CPInt cPInt1 = new CPInt(834);
      int int0 = cPInt0.compareTo(cPInt1);
      assertEquals((-1), int0);
      assertEquals(834, cPInt1.getInt());
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      CPInt cPInt0 = new CPInt((-38));
