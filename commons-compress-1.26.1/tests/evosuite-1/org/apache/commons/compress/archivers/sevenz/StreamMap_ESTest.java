...
public class StreamMap_ESTest extends StreamMap_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      assertEquals("StreamMap with indices of 6 folders, offsets of 6 packed streams, first files of 6 folders and folder indices for 6 files", string0);
  }
  ...
  public void test1()  throws Throwable  {
      ...
      String string0 = streamMap0.toString();
      assertEquals("StreamMap with indices of 2 folders, offsets of 6 packed streams, first files of 2 folders and folder indices for 2 files", string0);
  }
