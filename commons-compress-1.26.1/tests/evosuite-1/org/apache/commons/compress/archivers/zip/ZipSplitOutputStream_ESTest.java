...
public class ZipSplitOutputStream_ESTest extends ZipSplitOutputStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(path0, (-2804L));
  ...
  public void test3()  throws Throwable  {
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream((File) null, 400L);
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{I0gxlf.aF}5");
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(mockFile0, 4294967348L);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test5()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
            @Override public void run() { 
        try {
          MockFile mockFile0 = new MockFile("ax:aT[~_e;Ggv", "ax:aT[~_e;Ggv");
          ZipSplitOutputStream zipSplitOutputStream0 = null;
          try {
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.io.FilePermission\" \"/Users/mkim754/IdeaProjects/aster-benchmark/commons-compress-1.26.1/ax:aT[~_e;Ggv/ax:aT[~_e;Ggv\" \"write\")
             // java.lang.Thread.getStackTrace(Thread.java:1559)
             // org.evosuite.runtime.sandbox.MSecurityManager.checkPermission(MSecurityManager.java:424)
             // java.lang.SecurityManager.checkWrite(SecurityManager.java:979)
             // sun.nio.fs.UnixChannelFactory.open(UnixChannelFactory.java:247)
