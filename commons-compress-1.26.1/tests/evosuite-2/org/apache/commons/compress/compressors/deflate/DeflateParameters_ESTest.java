...
public class DeflateParameters_ESTest extends DeflateParameters_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      assertEquals(9, deflateParameters0.getCompressionLevel());
  }
  ...
  public void test2()  throws Throwable  {
      ...
      deflateParameters0.setCompressionLevel(1);
  ...
  public void test3()  throws Throwable  {
      ...
      try { 
        deflateParameters0.setCompressionLevel(840);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: 840
         //
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        deflateParameters0.setCompressionLevel((-3908));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: -3908
         //
         verifyException("org.apache.commons.compress.compressors.deflate.DeflateParameters", e);
      }
  }
