...
public class Parameters_ESTest extends Parameters_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals(8, parameters0.getMaxBackReferenceLength());
  ...
  public void test04()  throws Throwable  {
      Parameters.Builder parameters_Builder0 = Parameters.builder(16);
      parameters_Builder0.withNiceBackReferenceLength((-1));
      Parameters parameters0 = parameters_Builder0.build();
  ...
  public void test06()  throws Throwable  {
      Parameters.Builder parameters_Builder0 = Parameters.builder(8);
      parameters_Builder0.withMaxNumberOfCandidates((-4731));
      Parameters parameters0 = parameters_Builder0.build();
      int int0 = parameters0.getMaxCandidates();
      assertTrue(parameters0.getLazyMatching());
      assertEquals(8, parameters0.getWindowSize());
  ...
  public void test07()  throws Throwable  {
      Parameters.Builder parameters_Builder0 = Parameters.builder(4);
      parameters_Builder0.withLazyThreshold((-1));
      Parameters parameters0 = parameters_Builder0.build();
      int int0 = parameters0.getLazyMatchingThreshold();
      assertTrue(parameters0.getLazyMatching());
      assertEquals(3, parameters0.getMinBackReferenceLength());
      assertEquals(3, parameters0.getNiceBackReferenceLength());
      assertEquals(3, parameters0.getMaxBackReferenceLength());
      assertEquals(4, parameters0.getWindowSize());
      assertEquals(3, parameters0.getMaxOffset());
      assertEquals((-1), int0);
      assertEquals(4, parameters0.getMaxLiteralLength());
      assertEquals(256, parameters0.getMaxCandidates());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        parameters_Builder0.withMinBackReferenceLength(328);
  ...
  public void test12()  throws Throwable  {
      Parameters.Builder parameters_Builder0 = Parameters.builder(32);
      Parameters.Builder parameters_Builder1 = parameters_Builder0.withMaxOffset(4563);
      assertSame(parameters_Builder0, parameters_Builder1);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Parameters.Builder parameters_Builder1 = parameters_Builder0.withMaxBackReferenceLength(2);
      assertSame(parameters_Builder0, parameters_Builder1);
  }
  ...
  public void test29()  throws Throwable  {
      Parameters.Builder parameters_Builder0 = Parameters.builder(16);
      Parameters.Builder parameters_Builder1 = parameters_Builder0.withLazyMatching(true);
      assertSame(parameters_Builder1, parameters_Builder0);
  }
}
