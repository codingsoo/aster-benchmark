...
public class FramedLZ4CompressorOutputStream_ESTest extends FramedLZ4CompressorOutputStream_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("org.apache.commons.compress.compressors.lz4.FramedLZ4CompressorOutputStream$Parameters");
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream(mockFile0, false);
      FramedLZ4CompressorOutputStream framedLZ4CompressorOutputStream0 = null;
      try {
        framedLZ4CompressorOutputStream0 = new FramedLZ4CompressorOutputStream(mockFileOutputStream0, framedLZ4CompressorOutputStream_Parameters0);
  ...
  public void test6()  throws Throwable  {
      MockFileOutputStream mockFileOutputStream0 = new MockFileOutputStream("LZ4 Parameters with BlockSize K64, withContentChecksum true, withBlockChecksum false, withBlockDependency false", false);
      FramedLZ4CompressorOutputStream framedLZ4CompressorOutputStream0 = null;
      try {
        framedLZ4CompressorOutputStream0 = new FramedLZ4CompressorOutputStream(mockFileOutputStream0);
        fail("Expecting exception: NoClassDefFoundError");
