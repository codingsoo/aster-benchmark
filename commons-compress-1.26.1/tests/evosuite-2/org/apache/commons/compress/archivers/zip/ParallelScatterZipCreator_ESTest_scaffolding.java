...
public class ParallelScatterZipCreator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.compress.archivers.zip.ParallelScatterZipCreator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ThreadGroup", false, ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.Callable", false, ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.ThreadFactory", false, ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.compress.archivers.zip.ZipArchiveEntryRequestSupplier", false, ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.compress.parallel.InputStreamSupplier", false, ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ParallelScatterZipCreator_ESTest_scaffolding.class.getClassLoader()); 
