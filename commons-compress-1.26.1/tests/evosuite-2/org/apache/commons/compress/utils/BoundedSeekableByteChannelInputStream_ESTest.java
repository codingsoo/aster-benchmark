...
public class BoundedSeekableByteChannelInputStream_ESTest extends BoundedSeekableByteChannelInputStream_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try { 
        boundedSeekableByteChannelInputStream0.read(242L, (ByteBuffer) null);
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        boundedSeekableByteChannelInputStream0 = new BoundedSeekableByteChannelInputStream(2939L, (-1L), (SeekableByteChannel) null);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid length of stream at offset=2939, length=-1
         //
