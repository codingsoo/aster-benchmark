...
public class ZstdCompressorOutputStream_ESTest extends ZstdCompressorOutputStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      ZstdCompressorOutputStream zstdCompressorOutputStream0 = null;
      try {
        zstdCompressorOutputStream0 = new ZstdCompressorOutputStream(pipedOutputStream0, 0);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test2()  throws Throwable  {
      ZstdCompressorOutputStream zstdCompressorOutputStream0 = null;
      try {
        zstdCompressorOutputStream0 = new ZstdCompressorOutputStream((OutputStream) null, (-270), true);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test3()  throws Throwable  {
      ...
      ZstdCompressorOutputStream zstdCompressorOutputStream0 = null;
      try {
        zstdCompressorOutputStream0 = new ZstdCompressorOutputStream(pipedOutputStream0, (-3), false, false);
        fail("Expecting exception: NoClassDefFoundError");
