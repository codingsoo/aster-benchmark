...
public class DeflateParameters_ESTest extends DeflateParameters_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        deflateParameters0.setCompressionLevel(2452);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: 2452
         //
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        deflateParameters0.setCompressionLevel((-3864));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: -3864
         //
         verifyException("org.apache.commons.compress.compressors.deflate.DeflateParameters", e);
      }
  }
