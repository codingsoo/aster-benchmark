...
public class Deflate64CompressorInputStream_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.compress.compressors.deflate64.Deflate64CompressorInputStream"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Deflate64CompressorInputStream_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Deflate64CompressorInputStream_ESTest_scaffolding.class.getClassLoader()); 
