...
public class CPInt_ESTest extends CPInt_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      CPInt cPInt0 = new CPInt(480);
      CPInt cPInt1 = new CPInt(2574);
      int int0 = cPInt1.compareTo(cPInt0);
      assertEquals(1, int0);
      assertEquals(2574, cPInt1.getInt());
  }

  @Test(timeout = 4000)
  public void test3()  throws Throwable  {
      CPInt cPInt0 = new CPInt(0);
      CPInt cPInt1 = new CPInt(1);
      int int0 = cPInt0.compareTo(cPInt1);
      assertEquals((-1), int0);
      assertEquals(1, cPInt1.getInt());
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      CPInt cPInt0 = new CPInt((-1087));
