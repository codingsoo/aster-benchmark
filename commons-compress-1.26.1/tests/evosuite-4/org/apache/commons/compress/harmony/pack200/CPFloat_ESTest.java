...
public class CPFloat_ESTest extends CPFloat_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      CPFloat cPFloat0 = new CPFloat(2341.36F);
      float float0 = cPFloat0.getFloat();
      assertEquals(2341.36F, float0, 0.01F);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      CPFloat cPFloat0 = new CPFloat((-2110.8835F));
      int int0 = cPFloat0.compareTo(cPFloat0);
      assertEquals(0, int0);
      assertEquals((-2110.8835F), cPFloat0.getFloat(), 0.01F);
  }

  @Test(timeout = 4000)
  public void test3()  throws Throwable  {
      CPFloat cPFloat0 = new CPFloat(2341.36F);
      CPFloat cPFloat1 = new CPFloat(0.0F);
