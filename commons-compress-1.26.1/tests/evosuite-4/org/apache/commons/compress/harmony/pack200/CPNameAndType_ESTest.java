...
public class CPNameAndType_ESTest extends CPNameAndType_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("h`b@N");
  ...
  public void test01()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("RqCRX-3");
      LinkedList<CPClass> linkedList0 = new LinkedList<CPClass>();
      CPSignature cPSignature0 = new CPSignature("", cPUTF8_0, linkedList0);
      CPNameAndType cPNameAndType0 = new CPNameAndType(cPUTF8_0, cPSignature0);
  ...
  public void test07()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("-KS(@u(Bxhg4\"+fkf");
      LinkedList<CPClass> linkedList0 = new LinkedList<CPClass>();
      CPSignature cPSignature0 = new CPSignature("*!|zB6V$M7Z=O0y:", cPUTF8_0, linkedList0);
      CPNameAndType cPNameAndType0 = new CPNameAndType(cPUTF8_0, cPSignature0);
      CPSignature cPSignature1 = new CPSignature("fiUY%Y>x(&G{g", cPUTF8_0, linkedList0);
  ...
  public void test09()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("tCf)^W");
      CPSignature cPSignature0 = new CPSignature("tCf)^W", cPUTF8_0, (List<CPClass>) null);
  ...
  public void test11()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("srJjU=JNB@/cu");
      LinkedList<CPClass> linkedList0 = new LinkedList<CPClass>();
      CPSignature cPSignature0 = new CPSignature("srJjU=JNB@/cu", cPUTF8_0, linkedList0);
      CPNameAndType cPNameAndType0 = new CPNameAndType(cPUTF8_0, cPSignature0);
      CPSignature cPSignature1 = new CPSignature("srJjU=JNB@/cu:srJjU=JNB@/cu", cPUTF8_0, linkedList0);
      CPNameAndType cPNameAndType1 = new CPNameAndType(cPUTF8_0, cPSignature1);
      int int0 = cPNameAndType0.compareTo(cPNameAndType1);
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals("srJjU=JNB@/cu:srJjU=JNB@/cu", string0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      CPNameAndType cPNameAndType0 = new CPNameAndType(cPUTF8_0, cPSignature0);
      String string0 = cPNameAndType0.getName();
      assertEquals("srJjU=JNB@/cu", string0);
  }
  ...
  public void test16()  throws Throwable  {
      CPUTF8 cPUTF8_0 = new CPUTF8("-KS(@u(Bxhg4\"+fkf");
      LinkedList<CPClass> linkedList0 = new LinkedList<CPClass>();
      CPSignature cPSignature0 = new CPSignature("-KS(@u(Bxhg4\"+fkf", cPUTF8_0, linkedList0);
      CPNameAndType cPNameAndType0 = new CPNameAndType(cPUTF8_0, cPSignature0);
      int int0 = cPNameAndType0.getTypeIndex();
      assertEquals((-1), int0);
  }
