...
public class ZipSplitOutputStream_ESTest extends ZipSplitOutputStream_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          File file0 = MockFile.createTempFile("4z82`", "/");
          ZipSplitOutputStream zipSplitOutputStream0 = null;
          try {
            zipSplitOutputStream0 = new ZipSplitOutputStream(file0, 4294967295L);
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"/var/folders/9s/n46_h6v14tz3gvv43tjl9mth0000gq/T/4z82`0\" \"write\")
        ...
        try {
          ...
          try {
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.io.FilePermission\" \"/Users/mkim754/IdeaProjects/aster-benchmark/commons-compress-1.26.1/org.apache.commons.compress.archivers.zip.ZipArchiveEntry/org.apache.commons.compress.archivers.zip.ZipArchiveEntry\" \"write\")
             // java.lang.Thread.getStackTrace(Thread.java:1559)
             // org.evosuite.runtime.sandbox.MSecurityManager.checkPermission(MSecurityManager.java:424)
             // java.lang.SecurityManager.checkWrite(SecurityManager.java:979)
             // sun.nio.fs.UnixChannelFactory.open(UnixChannelFactory.java:247)
  ...
  public void test2()  throws Throwable  {
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream((Path) null, 2147483647L);
  ...
  public void test3()  throws Throwable  {
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream((File) null, (-293L));
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      MockFile mockFile0 = new MockFile("The size of the entire central directory exceeds the limit of 4GByte.", "The size of the entire central directory exceeds the limit of 4GByte.");
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(mockFile0, 4294967392L);
  ...
  public void test5()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Ibu;A_deA)P(wd8", ".zip");
      Path path0 = mockFile0.toPath();
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(path0, 3672L);
        fail("Expecting exception: IllegalArgumentException");
