...
public class Zip64RequiredException_ESTest extends Zip64RequiredException_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      assertEquals("Bad extra field starting at 's size exceeds the limit of 4GByte.", string0);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      Zip64RequiredException zip64RequiredException0 = new Zip64RequiredException("Bad extra field starting at ");
      assertEquals("Bad extra field starting at ", zip64RequiredException0.getMessage());
  }
}
