...
public class X7875_NewUnix_ESTest extends X7875_NewUnix_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        x7875_NewUnix0.parseFromLocalFileData(byteArray0, 0, 2417);
  ...
  public void test01()  throws Throwable  {
      ...
      x7875_NewUnix0.parseFromLocalFileData(byteArray0, 1, (byte)3);
  ...
  public void test02()  throws Throwable  {
      ...
      try { 
        x7875_NewUnix0.parseFromLocalFileData(byteArray0, (byte) (-60), (-1));
  ...
  public void test03()  throws Throwable  {
      X7875_NewUnix x7875_NewUnix0 = new X7875_NewUnix();
      byte[] byteArray0 = new byte[7];
      x7875_NewUnix0.parseFromLocalFileData(byteArray0, 1, (byte)48);
  ...
  public void test05()  throws Throwable  {
      X7875_NewUnix x7875_NewUnix0 = new X7875_NewUnix();
      x7875_NewUnix0.setGID((-443L));
      byte[] byteArray0 = x7875_NewUnix0.getLocalFileDataData();
      assertArrayEquals(new byte[] {(byte)1, (byte)2, (byte) (-24), (byte)3, (byte)4, (byte)69, (byte) (-2), (byte) (-1), (byte) (-1)}, byteArray0);
  ...
  public void test07()  throws Throwable  {
      ...
      x7875_NewUnix0.parseFromLocalFileData(byteArray0, (byte)4, (byte)4);
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        x7875_NewUnix0.parseFromLocalFileData((byte[]) null, 218, 218);
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        x7875_NewUnix0.parseFromLocalFileData(byteArray0, 3, (byte)60);
        fail("Expecting exception: ZipException");
      
      } catch(ZipException e) {
         //
         // X7875_NewUnix invalid: gidSize 60 doesn't fit into 60 bytes
         //
         verifyException("org.apache.commons.compress.archivers.zip.X7875_NewUnix", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      byteArray0[1] = (byte) (-1);
      try { 
        x7875_NewUnix0.parseFromLocalFileData(byteArray0, 0, (byte)102);
        fail("Expecting exception: ZipException");
      
      } catch(ZipException e) {
         //
         // X7875_NewUnix invalid: uidSize 255 doesn't fit into 102 bytes
         //
         verifyException("org.apache.commons.compress.archivers.zip.X7875_NewUnix", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = x7875_NewUnix0.getLocalFileDataData();
      try { 
        x7875_NewUnix0.parseFromLocalFileData(byteArray0, (-2260), (-2260));
        fail("Expecting exception: ZipException");
      
      } catch(ZipException e) {
         //
         // X7875_NewUnix length is too short, only -2260 bytes
         //
         verifyException("org.apache.commons.compress.archivers.zip.X7875_NewUnix", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      x7875_NewUnix0.parseFromCentralDirectoryData(byteArray0, 0, (-1234567));
