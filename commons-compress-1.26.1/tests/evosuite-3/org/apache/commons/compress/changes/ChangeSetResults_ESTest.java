...
public class ChangeSetResults_ESTest extends ChangeSetResults_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      changeSetResults0.addedFromStream("s#}E~U`'e");
  ...
  public void test1()  throws Throwable  {
      ChangeSetResults changeSetResults0 = new ChangeSetResults();
      changeSetResults0.addedFromChangeSet("(Ui\">7EA.");
  ...
  public void test2()  throws Throwable  {
      ChangeSetResults changeSetResults0 = new ChangeSetResults();
      boolean boolean0 = changeSetResults0.hasBeenAdded("s#}E~U`'e");
  ...
  public void test3()  throws Throwable  {
      ChangeSetResults changeSetResults0 = new ChangeSetResults();
      changeSetResults0.addedFromChangeSet("(Ui\">7EA.");
      boolean boolean0 = changeSetResults0.hasBeenAdded("(Ui\">7EA.");
      assertTrue(boolean0);
  }
  ...
  public void test5()  throws Throwable  {
      ChangeSetResults changeSetResults0 = new ChangeSetResults();
      changeSetResults0.deleted("s#}E~U`'e");
      List<String> list0 = changeSetResults0.getDeleted();
      assertTrue(list0.contains("s#}E~U`'e"));
  }
