...
public class DeflateParameters_ESTest extends DeflateParameters_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        deflateParameters0.setCompressionLevel(156);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: 156
         //
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        deflateParameters0.setCompressionLevel((-1266));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid Deflate compression level: -1266
         //
         verifyException("org.apache.commons.compress.compressors.deflate.DeflateParameters", e);
      }
  }
