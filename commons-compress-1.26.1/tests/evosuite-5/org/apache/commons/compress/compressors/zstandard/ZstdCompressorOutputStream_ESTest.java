...
public class ZstdCompressorOutputStream_ESTest extends ZstdCompressorOutputStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ZstdCompressorOutputStream zstdCompressorOutputStream0 = null;
      try {
        zstdCompressorOutputStream0 = new ZstdCompressorOutputStream((OutputStream) null, 2002);
        fail("Expecting exception: NoClassDefFoundError");
  ...
  public void test3()  throws Throwable  {
      ...
      ZstdCompressorOutputStream zstdCompressorOutputStream0 = null;
      try {
        zstdCompressorOutputStream0 = new ZstdCompressorOutputStream(byteArrayOutputStream0, (-25), true, true);
        fail("Expecting exception: NoClassDefFoundError");
