...
public class Pack200Utils_ESTest extends Pack200Utils_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          MockFile mockFile0 = new MockFile("ft=tL\"yf_G)#");
          // Undeclared exception!
          try { 
            Pack200Utils.normalize((File) null, (File) mockFile0);
  ...
  public void test1()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
            @Override public void run() { 
        try {
          File file0 = MockFile.createTempFile("Lyjbw>zEM2q(z1A", "Lyjbw>zEM2q(z1A");
          HashMap<String, String> hashMap0 = new HashMap<String, String>();
          // Undeclared exception!
          try { 
            Pack200Utils.normalize(file0, file0, (Map<String, String>) hashMap0);
            fail("Expecting exception: SecurityException");
  ...
  public void test2()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
            @Override public void run() { 
        try {
          MockFile mockFile0 = new MockFile(",//5cqDTN");
          // Undeclared exception!
          try { 
