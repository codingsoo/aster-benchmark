...
public class ZipSplitOutputStream_ESTest extends ZipSplitOutputStream_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          File file0 = MockFile.createTempFile("B7JPjfi5i4{O", "B7JPjfi5i4{O");
          ZipSplitOutputStream zipSplitOutputStream0 = null;
          try {
            zipSplitOutputStream0 = new ZipSplitOutputStream(file0, 65536L);
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"/var/folders/9s/n46_h6v14tz3gvv43tjl9mth0000gq/T/B7JPjfi5i4{O0B7JPjfi5i4{O\" \"write\")
  ...
  public void test1()  throws Throwable  {
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream((Path) null, 4294967295L);
  ...
  public void test2()  throws Throwable  {
      ...
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(path0, (-2034L));
  ...
  public void test3()  throws Throwable  {
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream((File) null, 2L);
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      MockFile mockFile0 = new MockFile("qcYfrX7'f#W,1T)iJ");
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(mockFile0, (-1815L));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test5()  throws Throwable  {
      MockFile mockFile0 = new MockFile("F(.-|D@_ .]#W3n:e@qC", "F(.-|D@_ .]#W3n:e@qC");
      ZipSplitOutputStream zipSplitOutputStream0 = null;
      try {
        zipSplitOutputStream0 = new ZipSplitOutputStream(mockFile0, 4294967335L);
        fail("Expecting exception: IllegalArgumentException");
