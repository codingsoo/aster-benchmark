...
public class Lister_ESTest extends Lister_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      String[] stringArray0 = new String[1];
      stringArray0[0] = "Parameters: archive-name [archive-type]\n";
      Lister lister0 = new Lister(true, stringArray0);
      try { 
        lister0.go();
  ...
  public void test11()  throws Throwable  {
      String[] stringArray0 = new String[6];
      stringArray0[0] = "Error reading Zip content from ";
      stringArray0[1] = "tar";
      try { 
        Lister.main(stringArray0);
        fail("Expecting exception: NoSuchFileException");
